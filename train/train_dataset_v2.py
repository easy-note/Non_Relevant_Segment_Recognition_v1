...
class CAMIO_Dataset(Dataset):
    def __init__(self, csv_path, patient_name, is_train, random_seed, IB_ratio):
        ...
        self.ib_assets_df = self.ib_assets_df.sample(n=len(self.oob_assets_df)*IB_ratio, replace=False, random_state=random_seed) # 중복뽑기x, random seed 고정, OOB개수의 IB_ratio 개

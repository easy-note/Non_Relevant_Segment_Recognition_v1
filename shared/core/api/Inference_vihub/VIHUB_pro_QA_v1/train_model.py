"""
Define backbone model for train.
"""
...
class CAMIO(pl.LightningModule):
    ...
    def __init__(self, config:dict):
        ...
        self.backbone = self.hparams.backbone_model # config['backbone_model']

        print(config)
        print(self.init_lr)
        print(self.backbone) # 21.06.03 HG Comment - omg, mistake name of variable, it's backbone X-)
        ...
        if (self.backbone.find('vgg') != -1) : # # 21.06.03 HG 수정 - Add Support Model [VGG Family]
        ...
        elif (self.backbone.find('resnet') != -1) or (self.backbone.find('resnext') != -1) :
        ...
        elif self.backbone.find('mobilenet') != -1 : # 21.06.08 HG - 수정 - From JH code
        ...
        elif self.backbone.find('squeezenet') != -1 :# 21.06.05 HG 수정 - Squeezenet 모델에 맞게 수정 
            if self.backbone == 'squeezenet1_0' :
                print('MODEL = squeezenet1_0')
                self.model = models.squeezenet1_0(pretrained=True)

            elif self.backbone == 'squeezenet1_1' : # 21.06.05 HG 추가 - Squeezenet1_1
        ...
        elif self.backbone.find('efficientnet') != -1 :# 21.06.09 HG 추가 - Add supported model [Efficient Family]
            ...
            elif self.backbone == 'efficientnet_b2' :
            ...
            elif self.backbone == 'efficientnet_b5' : 
            ...
            elif self.backbone == 'efficientnet_b6' : 

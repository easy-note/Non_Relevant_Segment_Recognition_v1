...
# --emb_type 3 --save_path '/code/OOB_Recog/logs/general-3-1-step-org-seed' > /dev/null &
...
--batch_size 256 --lr_scheduler "step_lr" --lr_scheduler_step 5 --lr_scheduler_factor 0.9 --cuda_list '1' \
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-proxy-all' > /dev/null &
...
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--use_wise_sample \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-ws-emb-proxy-all' > /dev/null &
...
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--use_wise_sample \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-ws-emb-all-loss' > /dev/null &
...
nohup python inference_only.py --fold '1' --trial 1 --model "mobilenetv3_large_100" --max_epoch 100 \
--batch_size 256 --lr_scheduler "step_lr" --lr_scheduler_step 5 --lr_scheduler_factor 0.9 --cuda_list '0' \
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--use_online_mcd --emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-mcd' \
--restore_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-mcd-trial:1-fold:1/TB_log/version_0' > /dev/null &
...
--batch_size 256 --lr_scheduler "step_lr" --lr_scheduler_step 5 --lr_scheduler_factor 0.9 --cuda_list '0' \
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-proxy-all' \
--restore_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-proxy-all-trial:1-fold:1/TB_log/version_0' > /dev/null &
...
--batch_size 256 --lr_scheduler "step_lr" --lr_scheduler_step 5 --lr_scheduler_factor 0.9 --cuda_list '1' \
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-half' > /dev/null &
...
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--use_wise_sample \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-ws-emb-half' > /dev/null &
...
--use_online_mcd \
--use_wise_sample \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-ws-emb-mcd' > /dev/null &
...
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--use_online_mcd \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-mcd-proxy-all' > /dev/null &
...
--use_online_mcd \
--use_wise_sample \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-ws-emb-mcd-proxy-all' > /dev/null &
...
--batch_size 256 --lr_scheduler "step_lr" --lr_scheduler_step 5 --lr_scheduler_factor 0.9 --cuda_list '0' \
--IB_ratio 3 --random_seed 3829 --stage 'hem_train' --hem_extract_mode 'hem-emb-online' --inference_fold '1' \
--emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-step-emb-proxy-neg-weight' > /dev/null &
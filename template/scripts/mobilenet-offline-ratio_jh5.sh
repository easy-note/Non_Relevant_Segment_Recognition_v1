...
do
    python visual_flow.py \
        ...
        --stage "hem_train" \
        --inference_fold "1" \
        --experiments_sheet_dir "/OOB_RECOG/results/all-offline-MC=1-top_ratio=0.10-WS=3-experiment" \
        --save_path "/OOB_RECOG/logs/all-offline-MC=1-top_ratio=0.10-WS=3-experiment"
done;
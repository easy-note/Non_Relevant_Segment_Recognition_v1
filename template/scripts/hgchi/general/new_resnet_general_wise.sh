...
nohup python -u ../../new_visual_flow.py \
    ...
    --experiments_sheet_dir "/OOB_RECOG/results-offline/general/new_resnet_general_wise" \
    --save_path "/OOB_RECOG/logs-offline/general/new_resnet_general_wise" > "./nohup_logs/new_resnet_general_wise.out"
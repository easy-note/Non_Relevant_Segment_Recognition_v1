...
baby_model_save_path="/OOB_RECOG/logs-lapa/mobilenet-set2-visual1"
...
do
    nohup python -u ../new_apply_offline_methods_flow.py \
        ...
        --experiments_sheet_dir "/OOB_RECOG/results-lapa/mobilenet-set2-apply1" \
        --save_path "/OOB_RECOG/logs-lapa/mobilenet-set2-apply1" > "./nohup_logs/lapa-set2-apply1.out"
done;
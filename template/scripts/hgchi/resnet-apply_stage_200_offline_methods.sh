...
do
    nohup python ../apply_offline_methods_flow.py \
        ...
        --save_path "/OOB_RECOG/logs-${theator_stage_flag}/resnet_apply_offline_methods-all-offline-IB_ratio=${IB_ratio}-ws_ratio=${WS_ratio}-MC=${n_dropout}-experiment" > /dev/null
done;
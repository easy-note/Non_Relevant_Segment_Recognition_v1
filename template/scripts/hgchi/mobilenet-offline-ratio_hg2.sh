...
do
    nohup python visual_flow.py \
        ...
        --stage "hem_train" \
        --inference_fold "1" \
        --experiments_sheet_dir "/OOB_RECOG/results/all-offline-MC=1-ws_ratio=3-experiment" \
        --save_path "/OOB_RECOG/logs/all-offline-MC=1-ws_ratio=3-experiment" > /dev/null
done;
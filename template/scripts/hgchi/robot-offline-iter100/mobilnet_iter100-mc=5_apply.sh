...
baby_model_save_path="/OOB_RECOG/logs_robot-offline-iter100/mobilenet_iter100_visual"
...
do
    nohup python -u ../../new_apply_offline_methods_flow.py \
        ...
        --experiments_sheet_dir "/OOB_RECOG/results_robot-offline-iter100/mobilenet_iter100_apply-MC=5" \
        --save_path "/OOB_RECOG/logs_robot-offline-iter100/mobilenet_iter100_apply-MC=5" > "./nohup_logs/mobilenet_iter100_apply-MC=5.out"
done;
...
def get_experiment_args():
    ...
    parser.add_argument('--experiments_sheet_dir', type=str, 
                        default='/OOB_RECOG/template/results-temp',
    ...
    # for hem
    args.hem_extract_mode = 'general' # ['general', 'hem-softmax-offline', 'hem-voting-offline', 'hem-vi-offline', 'hem-emb-online', 'hem-emb2-online', 'hem-emb3-online'],

    ### train args
    args.fold = '1'
    args.save_path = '/OOB_RECOG/logs/hem-softmax-offline-temp'
    args.num_gpus = 1
    args.max_epoch = 1
    args.min_epoch = 1

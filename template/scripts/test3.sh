...
--use_online_mcd \
--use_wise_sample \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-ws-all-proxy-mcd-update' > /dev/null &
...
--use_online_mcd \
--use_wise_sample \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-ws-half-proxy-mcd-update' > /dev/null &
...
--use_online_mcd \
--use_wise_sample \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs/hem-online-3-1-ws-neg-proxy-mcd-update' > /dev/null &

...
--WS_ratio 3 \
--use_neg_proxy \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs-repvgg/repvgg-a0-neg-proxy' > /dev/null &
...
--use_wise_sample \
--use_oversample \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs-repvgg/repvgg-a0-ws-general-oversample' > /dev/null &
...
--use_proxy_all \
--use_online_mcd \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs-repvgg/repvgg-a0-ws-all-proxy-mcd' > /dev/null &
...
--WS_ratio 3 \
--use_wise_sample \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs-other-fold/repvgg-a0-ws-proxy' > /dev/null &
...
--use_wise_sample \
--use_neg_proxy \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs-other-fold/repvgg-a0-ws-neg-proxy' > /dev/null &
...
--WS_ratio 3 \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs-other-fold/repvgg-a0-general' > /dev/null &
...
--WS_ratio 3 \
--use_wise_sample \
--sampling_type 1 --emb_type 2 --save_path '/code/OOB_Recog/logs-other-fold/repvgg-a0-ws-general' > /dev/null &

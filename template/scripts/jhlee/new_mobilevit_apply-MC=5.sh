...
baby_model_save_path="/OOB_RECOG/logs-new/baby-BEST/mobilevit-vanila-MC=1"
...
do
    nohup python -u ../new_apply_offline_methods_flow.py \
        ...
        --experiments_sheet_dir "/OOB_RECOG/results/mobilevit-apply-MC=5" \
        --save_path "/OOB_RECOG/logs-new/mobilevit-apply-MC=5" > "./mobilevit-apply-MC=5.out"
done;
...
--fold '1' --trial 1 --model "mobilenetv3_large_100" --max_epoch 100 \
...
--WS_ratio 3 \
--use_wise_sample \
--sampling_type 1 --emb_type 2 --save_path '/OOB_RECOG/logs/mobilenet-ws-proxy' \
--stage_flag \
--top_ratio 0.05 --n_dropout 5 \
--experiments_sheet_dir "/OOB_RECOG/results-onoff/mobilenet-ws-proxy" \
--restore_path '/OOB_RECOG/logs/mobilenet-ws-proxy-trial:1-fold:1/TB_log/version_0' > /dev/null
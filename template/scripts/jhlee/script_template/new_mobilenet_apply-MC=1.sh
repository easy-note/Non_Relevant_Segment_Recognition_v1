...
baby_model_save_path="/OOB_RECOG/logs-new/baby-BEST/mobilenet-vanila-MC=3"
...
do
    nohup python -u ../new_apply_offline_methods_flow.py \
        ...
        --experiments_sheet_dir "/OOB_RECOG/results/mobilenet-apply-MC=1" \
        --save_path "/OOB_RECOG/logs-new/mobilenet-apply-MC=1" > "./mobilenet-apply-MC=1.out"
done;
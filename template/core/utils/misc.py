...
def prepare_inference_aseets_vihub_gangbuk(case, anno_ver, inference_fold, save_path):
    from core.utils.prepare_vihub_gangbuk import InferenceAssets_vihub_gangbuk # inference assets helper (for prepare inference assets)
    from core.utils.prepare_vihub_gangbuk import OOBAssets_vihub_gangbuk # OOB assets helper (for prepare inference assets)
    from core.utils.parser import FileLoader # file load helper
    ...
    # InferenceAssets_etc
    inference_assets_save_path = os.path.join(save_path, 'patients_aseets.yaml')
    inference_assets_helper = InferenceAssets_vihub_gangbuk(case=case, anno_ver=anno_ver, fold=inference_fold)
    inference_assets = inference_assets_helper.get_inference_assets() # dict (yaml)
